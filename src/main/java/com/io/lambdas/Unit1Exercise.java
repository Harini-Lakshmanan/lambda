...
public class Unit1Exercise {
    ...
    private static void printListWithConditions(List<Person> people,Condition condition) {
        List<Person> filteredList = people.stream().filter(person -> condition.test(person)).collect(Collectors.toList());
